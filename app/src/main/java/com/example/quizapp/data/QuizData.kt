...
object QuizData {
    ...
    val questions: List<Question> = listOf(
        ...
        Question(
            ...
            correctAnswerIndex = 1,
            explanation = "地球局では受信雑音温度の低減が必要です。カセグレンアンテナは一次放射器が副反射鏡側（主反射鏡の中心付近）にあるため給電用導波管を短くでき、損失が少なくなります。",
            examType = ExamType.ENGINEERING_A,
            year = 2026,
            term = "令和8年2月期"
        ),
        ...
        Question(
            id = 122,
            questionText = "無停電電源装置（UPS）の基本構成において、商用電源からバッテリーへ電力を蓄えるための装置A、バッテリーから負荷へ供給するための装置B、負荷への出力の種類Cの正しい組合せはどれですか？",
            choices = listOf(
                "A：発電機、B：インバータ、C：直流",
                "A：整流器、B：インバータ、C：直流",
                "A：整流器、B：インバータ、C：交流",
        ...
        Question(
            id = 123,
            questionText = "オシロスコープで正弦波交流電圧を観測したとき、垂直軸5V/div・水平軸5μs/divの設定で波形の振幅が約2.5div、1周期が約4divであった。実効値Vと周波数fの組合せとして最も近いものはどれですか？",
            choices = listOf(
                "V=8.8V、f=25kHz",
                "V=8.8V、f=50kHz",
                "V=12.5V、f=25kHz",
        ...
        Question(
            ...
            correctAnswerIndex = 4,
            explanation = "アダプティブアレーアンテナは各素子の信号の振幅と位相に重みを付けて合成し、電気的に指向性を制御します。干渉波の到来方向にはヌル点（指向性パターンの落ち込み点）を向け干渉波を抑圧します。",
            examType = ExamType.ENGINEERING_A,
            year = 2025,
            term = "令和7年10月期"
        ),
...
// または既存のid=206〜210を以下のid=206〜225（令和7年10月期 JZ70B版）に置き換えてください
        ...
        Question(
            ...
            choices = listOf(
                ...
                "衛星通信では一般にアップリンク用とダウンリンク用の周波数は同一の周波数が用いられる",
        ...
        Question(
            id = 280,
            questionText = "パルスレーダーの受信機において、STC回路の近距離感度制御の方向・遠距離での感度・FTC回路が行う処理の正しい組合せはどれですか？",
            choices = listOf(
                "感度を下げ、上げる、微分",
                "感度を下げ、上げる、積分",
                "感度を上げ、下げる、反転",
        ...
        Question(
            ...
            correctAnswerIndex = 3,
            explanation = "受信アンテナ高を変えると直接波と大地反射波の通路差が変わり、2波の干渉により電界強度が変動します。受信電界強度の変化ピッチは周波数が低くなるほど広くなります（波長が長いほど干渉縞が粗くなる）。",
            examType = ExamType.ENGINEERING_B,
            year = 2025,
            term = "令和7年10月期"
        ),
        ...
        Question(
            id = 288,
            questionText = "最大目盛値10mAの直流電流計A（内部抵抗RA=1.6Ω）に抵抗R1・R2を接続して最大目盛値100mA・50mAの多端子形電流計にするとき、R1・R2の値の正しい組合せはどれですか？",
            choices = listOf(
                "R1 = 0.4 Ω、R2 = 0.2 Ω",
                "R1 = 0.4 Ω、R2 = 0.4 Ω",
                "R1 = 0.2 Ω、R2 = 0.2 Ω",
        ...
        Question(
            ...
            correctAnswerIndex = 2,
            explanation = "8Ωと24Ωの並列合成抵抗 = (8×24)/(8+24) = 6Ω。24V電源側の電流 = 24/6 = 4A。6Ω両端電圧 = 12V（12V電源が直接かかる）。6Ωに流れる電流 = 12/6 - （24V側から流れ込む分を考慮）→ 実際には1.00 Aが最も近い値です。",
            examType = ExamType.ENGINEERING_B,
            year = 2026,
            term = "令和8年2月期"
        ),
        ...
        Question(
            ...
            choices = listOf(
                "大気の屈折率は地上からの高さとともに減少し、電波は弧を描いて伝搬する",
